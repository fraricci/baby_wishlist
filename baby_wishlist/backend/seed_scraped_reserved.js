...
const items = [
  ...
  {"name": "Vêtements bébé", "price": 200, "is_available": true, "image_url": "https://www.kadolog.com/sites/default/files/styles/medium/public/2026/359822/1732582811_garde-robe-ancienne-pour-bebe-ou-trouver-des-pieces-authentiques-1024x585.jpg?itok=lQf9sFc5"},
  ...
  {"name": "Abonnement langes", "price": 200, "is_available": true, "image_url": "https://www.kadolog.com/sites/default/files/styles/medium/public/2026/359822/Capture%20d%E2%80%99%C3%A9cran%202023-12-13%20%C3%A0%2011-23-22.png?itok=aABWupVj"},
...
async function seed() {
  try {
    ...
    console.log('Database seeded with scraped items (including reserved)');
    process.exit(0);
  } catch (err) {
